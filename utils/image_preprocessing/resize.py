...
def resizeImages(src_dir, dst_dir, target_size=(224,224), ext_dict=None, output_suffix=".jpg"):
...
if __name__ == "__main__":
	...
	if proceed in yes:
		...
		resizeImages(source_dir, destination_dir, target_size,total_files, output_suffix)
	else:
		print("Aborted")
